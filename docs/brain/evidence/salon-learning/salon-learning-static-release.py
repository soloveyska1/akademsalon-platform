...
base=Path('/var/www/academic_saloon');stage=Path('/tmp/salon-learning-release190');archive=stage/'salon-public-release190-delta.tar.gz';manifest=json.loads((stage/'salon-public-release190-final.manifest.json').read_text())
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='c147c94ca4b47f54e9755854d10ced727ecbefac94bb5588a1e20e4bf1bae85a'
assert hashlib.sha256((stage/'salon-public-release190-final.manifest.json').read_bytes()).hexdigest()=='3c04bba45a6d1859bafae40d7d4daef99a74d044c0dfb60624dfd2a1c67f3983'
assert manifest['source_commit']=='1940537dc441f75551dbfde47274fd68ad13064b'
old=base/'releases/release189-3988a471';release=base/'releases/release190-1940537d'
assert (base/'current').resolve()==old and (base/'dist').resolve()==old
assert not release.exists()
unpack=Path(tempfile.mkdtemp(prefix='.release190-',dir=base/'releases'))
...
def verify(target,modern):
 ...
 if modern:
  for path in ['knowledge.html', 'tools.html', 'check.html', 'audit-temy-vkr.html', 'proverka-istochnikov-vkr.html', 'dosie-nauchruka.html', 'oplaceno.html', 'gift.html', 'assets/css/salon-library.css', 'assets/css/salon-tools.css', 'assets/js/salon-library.js', 'assets/js/salon-tools.js', 'assets/js/polish15-supporting.js', 'assets/js/salon-experience.js', 'guide-antiplagiat-ai.html', 'guide-apellyaciya.html', 'guide-dnevnik-praktiki.html', 'guide-harakteristika-s-praktiki.html', 'guide-kursovaya-za-nedelyu.html', 'guide-normocontrol.html', 'guide-obekt-predmet-cel-zadachi.html', 'guide-otchet-po-praktike.html', 'guide-otzyv-rukovoditelya-vkr.html', 'guide-prakticheskaya-chast-kursovoy.html', 'guide-prezentaciya-k-zashchite.html', 'guide-prilozheniya-po-gost.html', 'guide-recenziya-na-vkr.html', 'guide-rech-na-zashchitu.html', 'guide-rinc-statya.html', 'guide-skolko-stoit-diplomnaya.html', 'guide-skolko-stoit-kursovaya.html', 'guide-spisok-literatury.html', 'guide-temy-vkr.html', 'guide-titulnyj-list.html', 'guide-vkr-struktura.html', 'guide-vvedenie-kursovoy.html', 'guide-zaklyuchenie-kursovoy.html', 'guide-zaklyuchenie-vkr.html', 'guide-zashchita-diploma.html']:
