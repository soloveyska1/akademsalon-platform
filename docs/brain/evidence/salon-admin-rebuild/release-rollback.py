...
base=Path('/var/www/academic_saloon');stage=Path('/tmp/salon-control-release202');archive=stage/'salon-public-release202-delta.tar.gz';manifest=json.loads((stage/'salon-public-release202.manifest.json').read_text())
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='cbe1a5df2452aa321f16255796798b68a2f91a9d66aefd72b777c30854f9e455'
assert hashlib.sha256((stage/'salon-public-release202.manifest.json').read_bytes()).hexdigest()=='cf05b4926b19080da37d3ddd7fead7ac4687436fae1564b824d6fe883003ba4c'
assert manifest['source_commit']=='1a211115ebeaf4caf98ea9e374e74c0ac61e0ad1'
old=base/'releases/release201-7ed5e283';release=base/'releases/release202-1a211115'
assert (base/'current').resolve()==old and (base/'dist').resolve()==old
assert not release.exists()
unpack=Path(tempfile.mkdtemp(prefix='.release202-',dir=base/'releases'))
...
def verify(target,modern):
 ...
 if modern:
  for path in ['index.html', 'dashboard.html', 'configurator.html', 'zayavka.html', 'services.html', 'kursovaya-rabota.html', 'kursovaya-po-psihologii.html', 'benefits.html', 'admin.html', 'privacy.html', 'oferta.html', 'referral.html', 'referral-rules.html', 'sitemap.xml', 'sw.js', 'assets/js/app.js', 'assets/js/salon-workspace.js', 'assets/css/salon-workspace.css', 'assets/js/admin.js', 'assets/js/salon-admin-core.js', 'assets/js/salon-admin-workspace.js', 'assets/css/salon-admin-workspace.css', 'assets/css/salon-admin.css', 'assets/css/salon-referral-public.css']:
