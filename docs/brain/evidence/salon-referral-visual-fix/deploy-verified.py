...
base=Path('/var/www/academic_saloon');stage=Path('/tmp/salon-control-release201');archive=stage/'salon-public-release201-delta.tar.gz';manifest=json.loads((stage/'salon-public-release201.manifest.json').read_text())
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='d3f63ff8641254a6760c4bbffc50544a6d05139771088bc11503060d5653ea62'
assert hashlib.sha256((stage/'salon-public-release201.manifest.json').read_bytes()).hexdigest()=='fc37eec363cf37a7743d6a36b5af103a99ebcf05e4e6c3dd1a357f46ac45986b'
assert manifest['source_commit']=='7ed5e283970082fcc1f016e6ffccba4a8b762798'
old=base/'releases/release200-4dfb5dc3';release=base/'releases/release201-7ed5e283'
assert (base/'current').resolve()==old and (base/'dist').resolve()==old
assert not release.exists()
unpack=Path(tempfile.mkdtemp(prefix='.release201-',dir=base/'releases'))
...
def verify(target,modern):
 ...
 if modern:
  for path in ['index.html', 'dashboard.html', 'configurator.html', 'zayavka.html', 'services.html', 'kursovaya-rabota.html', 'kursovaya-po-psihologii.html', 'benefits.html', 'admin.html', 'privacy.html', 'oferta.html', 'referral.html', 'referral-rules.html', 'sitemap.xml', 'sw.js', 'assets/js/app.js', 'assets/js/salon-workspace.js', 'assets/css/salon-workspace.css', 'assets/js/admin.js', 'assets/css/salon-admin.css', 'assets/css/salon-referral-public.css']:
