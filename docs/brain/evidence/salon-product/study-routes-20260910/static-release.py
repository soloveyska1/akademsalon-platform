...
base=Path('/var/www/academic_saloon');stage=Path('/tmp/salon-study-release197');archive=stage/'salon-public-release197-delta.tar.gz';manifest=json.loads((stage/'salon-public-release197.manifest.json').read_text())
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='a19d462b43c6e7f854dfa6317a0a11937bc43b148d163dd35a3db71156834438'
assert hashlib.sha256((stage/'salon-public-release197.manifest.json').read_bytes()).hexdigest()=='dffe6edd34b6d580e6008ad292810bff0fb3a6c5ed16803ebbf9b1c4cf16d2bf'
assert manifest['source_commit']=='be99a1d914d7063f7232ab7d243d3a6503ad317d'
old=base/'releases/release196-55ed92ad';release=base/'releases/release197-be99a1d9'
assert (base/'current').resolve()==old and (base/'dist').resolve()==old
assert not release.exists()
unpack=Path(tempfile.mkdtemp(prefix='.release197-',dir=base/'releases'))
