...
base=Path('/var/www/academic_saloon');stage=Path('/tmp/salon-special-release192');archive=stage/'salon-public-release192-delta.tar.gz';manifest=json.loads((stage/'salon-public-release192-final.manifest.json').read_text())
assert hashlib.sha256(archive.read_bytes()).hexdigest()=='b92d2580243ffaf1e3df5264f4dce17bab30c0374909fb40abf1e7c9024907bd'
assert hashlib.sha256((stage/'salon-public-release192-final.manifest.json').read_bytes()).hexdigest()=='d37b01dc0ad4e94e91fead36a5085f2406423b7d4790a7924585b5719e618fb3'
assert manifest['source_commit']=='f26bb2e4045df364f91d8b9ec1e34ba86226922f'
old=base/'releases/release191-ba054338';release=base/'releases/release192-f26bb2e4'
assert (base/'current').resolve()==old and (base/'dist').resolve()==old
assert not release.exists()
unpack=Path(tempfile.mkdtemp(prefix='.release192-',dir=base/'releases'))
...
def verify(target,modern):
 ...
 if modern:
  for path in ['assets/css/salon-experience.css', 'assets/js/salon-experience.js', 'normokontrol-vkr.html', 'plan.html', 'redaktura-posle-ii.html', 'razbor-zamechaniy-nauchruka.html', 'dorabotka-otcheta-po-praktike.html', 'index.html', 'about.html', 'knowledge.html', 'services.html', 'gift.html', 'dashboard.html', 'configurator.html', 'priyomnaya.html', 'oplaceno.html', 'referral.html']:
