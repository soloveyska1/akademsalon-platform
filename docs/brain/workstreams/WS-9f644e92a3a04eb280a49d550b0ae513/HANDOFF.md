...
- Workstream: `WS-9f644e92a3a04eb280a49d550b0ae513`, active revision 2.
...
hard conflict or unresolved product truth. Documentation/bootstrap rollback is
an exact commit revert; there is no external state to undo.
