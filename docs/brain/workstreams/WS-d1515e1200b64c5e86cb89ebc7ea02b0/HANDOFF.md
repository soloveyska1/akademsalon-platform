...
- Unverified: production activation and live readback.
...
- Next: clean implementation commit, byte-identical rebuild, guarded release223 apply/rollback/forward and live static smoke.
