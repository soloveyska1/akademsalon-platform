...
(function () {
  ...
  window.SalonServices = [
    ...
    { id:'defense', label:'Презентация и речь к защите', from:3500, unit:'', code:'df',
      desc:'Слайды по готовой работе, текст доклада на 7 минут и вероятные вопросы комиссии.' },
    { id:'defensepack', label:'«К защите под ключ»: презентация + речь + нормоконтроль', from:7200, unit:'', code:'dp',
      desc:'Пакет со скидкой: нормоконтроль по методичке + презентация и речь. По отдельности — 8 500 ₽.' }
  ];
