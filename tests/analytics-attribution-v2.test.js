...
test('strict attribution precedes analytics v2 on every measured public page', () => {
  ...
  for (const file of measured) {
    ...
    assert.match(html, /<script(?: defer)? src="assets\/js\/analytics-attribution-v2\.js\?v=20260812analytics2"><\/script>\s*<script(?: defer)? src="assets\/js\/configurator-nav-guard\.js\?v=20260829nav1"><\/script>\s*<script(?: defer)? src="assets\/js\/analytics-v2\.js\?v=20260829analytics4"><\/script>/,
