...
test('общая навигация повторяет финальный концепт', () => {
  /* Первый уровень ведёт по первой задаче. Лояльность и способы расчёта
     остаются в меню и подвале после полученной ценности. */
  const NAV_EXPECTED = [
    ['services.html', 'Услуги'],
    ['tariffs.html', 'Цены'],
    ['knowledge.html', 'Библиотека'],
    ['prolog.html', 'Как работаем'],
  ];
  ...
  /* Выгоды и сертификат остаются доступными, но не конкурируют с маршрутом. */
