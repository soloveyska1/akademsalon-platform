...
const standaloneRoutes = ['admin-analytics.html', 'admin-covers.html', 'offline.html', 'oplaceno.html'];
...
test('all 94 root documents resolve to one explicit delivery and shell family', () => {
