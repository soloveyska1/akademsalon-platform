...
const releaseKey = '20260804release112';
const shellRuntimeKey = '20260806shell113';
const out005RuntimeKey = '20260806services113';
...
test('every changed public asset uses the release cache key', () => {
  ...
  assert.doesNotMatch(app, /mobile\.css\?v=(?!20260806shell113)/);
});
